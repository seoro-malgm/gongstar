          ...
          <div class="p-4">
            ...
            <div class="mb-4">
              ...
              <section>
                <ul class="list-unstyled mb-3">
                  <li class="d-flex align-items-center my-3" v-for="(item, i) in types" :key="i">
                    <input
                      type="checkbox"
                      ...
                      v-model="form.type"
                    />
                    <label :for="`type_${item}`" class="text-18 fw-600">{{ item }}</label>
                  </li>
                </ul>
              </section>
            </div>
            <div class="mb-4">
              ...
              <section>
                ...
                <div class="form-group mb-3">
                  <label class="text-14 fw-700 mb-1" for="url">레퍼런스 주소</label>
                  <input
                    type="text"
                    class="form-control"
                ...
                <div class="form-group mb-3">
                  ...
                  <div class="d-flex align-items-center">
                    <template v-if="!pending.file && !form.file?.url">
                      <label for="file" class="d-inline-block btn btn-black p-2 rounded-circle">
                  ...
                  <input class="form-control d-none" id="file" type="file" @change="fileAttached" />
...
export default {
  setup() {
    ...
    return { form, types, getURL, infos, submit, validate, fileAttached, pending };
  },
};
</script>
